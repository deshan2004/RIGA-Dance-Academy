  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-[#07020e] text-white pt-12 pb-16">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Left & Right Vertical Neon Light Beams matching artwork */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center">
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs sm:text-sm font-bold tracking-[0.25em] text-purple-200 uppercase mb-10 px-6 py-2.5 rounded-full bg-[#120726]/80 border border-purple-900/50 backdrop-blur-md shadow-[0_0_25px_rgba(168,85,247,0.25)]"
        >
