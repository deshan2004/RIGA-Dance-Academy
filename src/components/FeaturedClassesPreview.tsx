                  ...
                  >
                    ...
                    <div className="relative p-8 z-10 flex flex-col justify-end transform transition-transform duration-500 group-hover:-translate-y-2">
                      <div className="flex items-center gap-2 mb-3">
                        <span className="px-3 py-1 bg-purple-950/90 backdrop-blur-md rounded-full text-xs font-bold text-purple-200 tracking-widest uppercase border border-purple-500/50 shadow-[0_0_12px_rgba(168,85,247,0.3)]">
                          {cls.style}
                        </span>
                      ...
                      <h3 className="text-2xl font-black text-white mb-4 group-hover:text-purple-300 transition-colors tracking-wide">
                        {cls.title}
                      </h3>
                      ...
                      <div className="mt-5 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-purple-400 group-hover:text-white transition-colors">
