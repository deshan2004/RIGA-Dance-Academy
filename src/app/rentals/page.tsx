  ...
  return (
    <div className="min-h-screen bg-[#04000b] text-white flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="pt-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full relative z-10">
        <Link
          href="/"
          className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-purple-950/70 border border-purple-800/40 text-purple-300 hover:text-white hover:border-purple-500/60 hover:bg-purple-900/80 transition-all shadow-[0_0_15px_rgba(168,85,247,0.2)] hover:scale-105"
      ...
      <div className="max-w-3xl mx-auto px-4 py-16 text-center relative z-10 my-auto">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-wide text-white mb-4">
            Costume &amp; Prop <span className="text-metallic-purple">Rentals</span>
          </h1>

          <p className="text-purple-200/80 text-sm sm:text-base font-light leading-relaxed max-w-xl mb-8">
            We are curating an exclusive high-end performance wardrobe and prop rental catalog for dancers, troupes, and video productions. Stay tuned for our upcoming grand launch!
          </p>
